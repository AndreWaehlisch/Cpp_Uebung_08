...
// **********
  void
Bessjy::rat (const double x, const double *r, const double *s, const int n) 
{
...
// **********
  void
Bessjy::asp (const double *pn, const double *pd, const double *qn, const double *qd, const double fac) 
{
...
// **********
  double
Bessjy::jn (int n, const double x) 
{
...
// **********
  double
Bessjy::yn (const int n, const double x) 
{
...
// **********
  double
Bessik::poly (const double *cof, const int n, const double x) 
{
...
// **********
  double
Bessik::kn (const int n, const double x) 
{
...
// **********
  double
Bessik::in (const int n, const double x) 
{
